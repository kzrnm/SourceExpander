...
## [9.1.0] - 2026-07-20
## Added
- [SourceExpander.Embedder] Add SourceExpander_Embedder_PackJson, SourceExpander_Embedder_VersionOnly
## Removed
- Drop support for Roslyn3

## [9.0.1] - 2026-06-30
## Added
- Add EmbeddingType.SingleMetadataJson
### Changed
- [SourceExpander.Console] Read embedded data without Mono.Cecil
### Removed
- [SourceExpander.Console] Remove `--output` from embedded subcommand
