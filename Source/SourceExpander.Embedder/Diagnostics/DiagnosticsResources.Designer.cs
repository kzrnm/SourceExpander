...
namespace SourceExpander.Diagnostics {
    ...
    internal class DiagnosticsResources {
        ...
        /// <summary>
        ///   &apos;{0}&apos; cannot be used here に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string EMBED0012_Body {
            get {
                return ResourceManager.GetString("EMBED0012_Body", resourceCulture);
            }
        }
        
        /// <summary>
        ///   The attribute cannot be used here に類似しているローカライズされた文字列を検索します。
        /// </summary>
        internal static string EMBED0012_Title {
            get {
