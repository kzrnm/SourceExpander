...
public class ObsoleteConfigTest : EmbedderGeneratorTestBase
{
    ...
    public async Task ObsoleteConfig(InMemorySourceText additionalText, (string Obsolete, string Instead)[] diagnosticsArgs, CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
    ...
    public async Task ObsoleteConfigProperty(DummyAnalyzerConfigOptions analyzerConfigOptionsProvider, (string Obsolete, string Instead)[] diagnosticsArgs, CancellationToken cancellationToken)
    {
        var test = new Test
        {
