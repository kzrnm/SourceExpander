...
",
                new SourceFileInfo("TestAssembly>path.cs",
                    ...
                    new string[]{ "using System;" },
                    new string[0],
                    @"public class Def{public unsafe object M(){long x = 0;var p = &x;var pi = (Int32*)p;*pi = int.MaxValue;p->CompareTo(2);return pi[1];}public object M2(string str){unsafe{fixed (char *p = str){var pi = (Int32*)p;*pi = sizeof(DateTime);return pi[1];}}}}"
            )),
            new TestData("For", @"
using System;
public class Def
