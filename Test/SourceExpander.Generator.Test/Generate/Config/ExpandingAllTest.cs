...
{
    [Test]
    public async Task ExpandingAll(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
"""
                ...
                AdditionalProjectReferences = { "Other", "Other2" },
                AdditionalFiles = {
                    (
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task ExpandingAllProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
