...
{
    [Test]
    public async Task ExpandingPositionEndOfFile(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task ExpandingPositionAfterUsings(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task ExpandingPositionEndOfFileProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task ExpandingPositionAfterUsingsProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            AnalyzerConfigOptions =
