...
{
    [Test]
    public async Task IgnoreFile(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task IgnoreFileProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task Whitelist(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task WhitelistProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            AnalyzerConfigOptions =
