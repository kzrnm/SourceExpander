...
{
    [Test]
    public async Task IgnoreAssemblies(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""").ReplaceEOL())
    ...
    [Test]
    public async Task IgnoreAssembliesProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            AnalyzerConfigOptions =
            {
                ...
                { "build_property.SourceExpander_Generator_IgnoreAssemblies", "Other;ExAssembly" },
            },
            TestState =
            {
                AdditionalProjects =
