...
{
    [Test]
    public async Task MetadataExpandingFileNotFound(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task MetadataExpandingFileNotFoundProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task MetadataExpandingFile(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
// <auto-generated/>
#pragma warning disable
[assembly: global::System.Reflection.AssemblyMetadataAttribute("SourceExpander.Expanded.Default",{{{"""
using Other;
using System;
class Program
{
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task MetadataExpandingFileProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            AnalyzerConfigOptions =
