...
{
    [Test]
    public async Task StaticEmbeddingText(CancellationToken cancellationToken)
    {
        var test = new Test
        {
            TestState =
...
""".ReplaceEOL())
    ...
    [Test]
    public async Task StaticEmbeddingTextProperty(CancellationToken cancellationToken)
    {
        var test = new Test
        {
