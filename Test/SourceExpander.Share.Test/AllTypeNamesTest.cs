...
public class AllTypeNamesTest
{
    ...
    public async Task TypeName(TypeNameTestInput input, string[] expected, CancellationToken cancellationToken)
    {
        await RoslynUtil.AllTypeNames(input.Model, input.Tree, cancellationToken).Should().BeEquivalentTo(expected);
    }
}
