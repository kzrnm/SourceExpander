...
namespace SourceExpander.Share
{
    public class EmbeddedDataTest
    {
        ...
        public void Empty()
        {
            ...
            data.ShouldBeEquivalentTo(new EmbeddedData(
                    "Empty",
                    [],
                    new Version(1, 0, 0),
        ...
        public void RawJsonError()
        {
            ...
            var (data, errors) = EmbeddedData.Create("RawJson",
                           ...
                           .Add("SourceExpander.EmbeddedNamespaces", "SampleLibrary")
                           .Add("SourceExpander.EmbeddedLanguageVersion", "7.3"));
            errors.ShouldBe([("SourceExpander.EmbeddedSourceCode", "Invalid property identifier character: ]. Path '[0]', line 1, position 2.")]);
